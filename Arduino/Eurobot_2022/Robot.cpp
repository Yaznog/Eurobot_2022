...
{
  if (walkPolarStep == -1)      MoveOneLegToCoordinatePolar(mMovementPolarStop.module,   mMovementPolarStop.argument,  mMovementPolarStop.z,  leg);
  else if (walkPolarStep == 0)  MoveOneLegToCoordinatePolar(mMovementPolarStep0.module,  mMovementPolarStep0.argument, mMovementPolarStep0.z, leg);
  else if (walkPolarStep == 1)  MoveOneLegToCoordinatePolar(mMovementPolarStep1.module,  mMovementPolarStep1.argument, mMovementPolarStep1.z, leg);
  else if (walkPolarStep == 2)  MoveOneLegToCoordinatePolar(mMovementPolarStep2.module,  mMovementPolarStep2.argument, mMovementPolarStep2.z, leg);
  else if (walkPolarStep == 3)  MoveOneLegToCoordinatePolar(mMovementPolarStep3.module,  mMovementPolarStep3.argument, mMovementPolarStep3.z, leg);
